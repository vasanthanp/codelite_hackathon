...
const AdminEditProfile = () => {
  return (
    ...
    <AdminNavbar />
      <div className="login-box d-flex align-items-center justify-content-center w-100 " id="editProfileBox" style={{height: "93%"}}>
        <div
          ...
          id="AdminLoginBox"
        >
          <NavLink to={`/admin/profile/1`} className={`${style.backLink} px-4  pt-4 align-self-start`} ><i className="fas fa-chevron-left mr-2"></i>back</NavLink>
          <form
            id="AdminForm"
            className="py-3 w-100 d-flex flex-column align-items-center justify-content-center"
          >
            <p className={`px-4 align-self-start ${style.inputLabel}`}>Name</p>
            <input
              type="text"
            ...
            />
            <p className={`px-4 align-self-start ${style.inputLabel}`}>Email</p>
            <input
              type="email"
              className="form-control col-11 mt-0 mb-3 py-3 px-4 text-dark"
              id="adminEmail"
            ...
            <p className={`px-4 align-self-start ${style.inputLabel}`}>Mobile Number</p>
            <input
              type="text"
              className="form-control col-11 mt-0 mb-3 py-3 px-4 text-dark"
            ...
            />
            <p className={`px-4 align-self-start ${style.inputLabel}`}>Password</p>
            <input
              type="password"
              className="form-control col-11 mt-0 mb-3 py-3 px-4 text-dark"
              name="adminPassword"
            ...
            />
            <p className={`px-4 align-self-start ${style.inputLabel}`}>Company Name</p>
            <input
              type="text"
              className="form-control col-11 mt-0 mb-3 py-3 px-4 text-dark"
              id="companyName"
            ...
            />
            <p className={`px-4 align-self-start ${style.inputLabel}`}>Company Address</p>
            <input
              type="text"
              className="form-control col-11 mt-0 mb-3 py-3 px-4 text-dark"
              id="companyAddress"
