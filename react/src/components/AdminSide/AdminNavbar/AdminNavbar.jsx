...
export default function AdminNavbar(props) {
    return (
        <nav className="navbar navbar-expand-lg navbar-dark bg-dark " id="userNavbar">
        <Link className="navbar-brand" to="/admin/dashboard">Neo Bikes</Link>
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <span className=" my-2 my-lg-0">
                <ul className="navbar-nav mr-auto">
                    <li className="nav-item">
                        <Link className="nav-link" to="/login" id="adminLogoutButton"   onClick={()=>localStorage.clear()} >Logout</Link>
                    </li>
                </ul> 
            </span>
        </div>
